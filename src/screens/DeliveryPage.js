...
import {
  StyleSheet, Text, View, TouchableOpacity, Dimensions, ScrollView, Modal, Pressable, Button,
} from 'react-native';
  ...
  const noOrderView = () => {
    return (
      <View style={styles.container}>
        ...
        <Ionicons name="fast-food-outline" style={styles.foodIcon} />
    ...
    return (
      <View style={styles.container}>
        ...
        <Text style={styles.text2}>
          Your Payment Of $
          {currOrder.orderPaymentAmount / 100}
          {' '}
          Has Been Confirmed
        </Text>
        <View>
