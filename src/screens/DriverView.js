...
import {
  StyleSheet, Image, Text, View, TouchableOpacity, Dimensions, ScrollView, Modal, Pressable, Button, TouchableHighlight,
} from 'react-native';
...
function DriverView(props) {
  ...
  return (
    <View backgroundColor="#02604E" style={{ height: windowHeight * 0.9 }}>
      ...
      <View style={{ height: 'auto', minHeight: windowHeight * 0.1, maxHeight: windowHeight * 0.4 }}>
      ...
      <View style={{ height: 'auto', maxHeight: windowHeight * 0.5 }}>
        <ScrollView contentContainerStyle={styles.allOrdersContainer}>
          <View style={styles.itemsContainer}>
      ...
      >
        <View style={styles.itemModal}>
          ...
          <Text style={{ fontWeight: 'bold', fontSize: 20, marginTop: 10 }}>
            Order Total: $
            {selectedOrder.orderPaymentAmount / 100}
          </Text>
