...
import {
  StyleSheet, Text, View, TouchableHighlight, Dimensions, ScrollView, Modal, Pressable, Image, ImageBackground, TouchableOpacity,
} from 'react-native';
      ...
      <View style={{ width: windowWidth, height: windowHeight, backgroundColor: modalVisible ? 'rgba(0,0,0,.5)' : 'transparent' }}>
        ...
        >
          <View style={styles.itemModal}>
            ...
            <Text style={styles.itemModalCost}>
              $
              {selectedItem?.cost}
            </Text>
